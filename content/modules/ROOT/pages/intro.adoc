...
To get started, {DS_URL}#https://github.com/learn-quarkus/ibm-quarkus-workshop-m1-labs/tree/ocp-4.19/[access the Red Hat OpenShift Dev Spaces instance^] and select *Log in with OpenShift* button:
