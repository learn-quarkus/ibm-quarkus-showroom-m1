...
Now that your app is deployed to OpenShift you can also see it in the {CONSOLE_URL}[OpenShift Console^]. Login with your assigned username and password (e.g. `{USER_ID}/{OPENSHIFT_USER_PASSWORD}`):
