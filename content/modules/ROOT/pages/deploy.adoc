...
----
oc login -u %USER_ID% -p %PASSWORD% https://openshift.default.svc:443
----
...
Now that your app is deployed to OpenShift you can also see it in the https://console-openshift-console.{ROUTE_SUBDOMAIN}[OpenShift Console^]. Login with `%USER_ID%/%PASSWORD%`
